...
class RpgGame {
  ...
  static void startGame() {
    Boss boss = Boss(3000, 65, 'Dark Souls');
    ...
    Lucky lucky = Lucky(260, 11, 'Luis');
    Golem golem = Golem(450, 0, 'Golem');
    Witcher witcher = Witcher(280, 'Nekro');
    Thor thor = Thor(320, 17, 'Thor');

    List<Hero> heroes = [warrior1, warrior2, magic, doc, assistant, berserk, lucky, golem, witcher, thor];
